...
## Project Structure
    ...
    ├── testapiautoteammemb_65405  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_65405`
...
2. Clone this repo and `cd testapiautoteammemb_65405`
